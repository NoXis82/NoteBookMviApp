...
import com.noxis.database.editor.BoldStyle
import com.noxis.database.editor.FormattingAction
import com.noxis.database.editor.HeadingStyle
import com.noxis.database.editor.HighlightStyle
import com.noxis.database.editor.ItalicsStyle
import com.noxis.database.editor.StrikeThroughStyle
import com.noxis.database.editor.SubtitleStyle
import com.noxis.database.editor.UnderlineStyle

@Composable
internal fun ComposeTextEditor(
...
@Composable
@Preview
private fun ComposeTextEditorPreview() {
    ComposeTextEditor(
        annotatedString = AnnotatedString("Test"),
        activeFormats = setOf(),
        onAnnotatedStringChange = {},
        onFormattingSpansChange = {}
    )
}